            ...
            with self.static_server(repo) as site_port:
                with sync_playwright() as playwright:
                    ...
                    try:
                        ...
                        page.get_by_label("Title").fill("MVP Dogfood Publication 001")
                        page.get_by_label("Article body").fill(
                            "# MVP Dogfood Publication 001\n\nFirst website publication."
                        )
                        ...
                        expect(page.get_by_text("Saved").first).to_be_visible(timeout=5000)
                        ...
                        page.goto(f"{base_url}/setup/{session_id}/publication_plan")
                        expect(page.get_by_text("Version", exact=True)).to_be_visible()
