            ...
            with self.static_server(repo) as site_port:
                with sync_playwright() as playwright:
                    ...
                    try:
                        ...
                        expect(page.get_by_text("No commits yet; first commit will be created")).to_be_visible()
                        ...
                        expect(page.get_by_text(custom_seo)).to_be_visible()
                        ...
                        expect(page.get_by_text("Execution claimed")).to_be_visible(timeout=10000)
                        ...
                        page.reload()
                        expect(page.get_by_text("Completed", exact=True)).to_be_visible()
                        markdown = (repo / "articles" / "mvp-dogfood-publication-334.md").read_text(
                            encoding="utf-8"
                        )
