...
Owned-publication execution is website-first. Social distribution targets remain waiting until the Markdown Website predecessor reaches `publication_verified`. Reconciliation never repeats an uncertain Git push or social mutation blindly.
