...
"${PYBIN}" -m unittest tests.test_plugin_sdk_phase17 tests.test_plugin_distribution_phase18 tests.test_plugin_host_phase19
"${PYBIN}" -m py_compile $(find src/plugin_sdk plugin_sdk src/core/plugin_distribution src/core/plugin_host src/plugin_host_runtime integrations/plugin_registry integrations/plugin_host -name '*.py' -print) dashboard.py
"${PYBIN}" -m ruff check src/plugin_sdk plugin_sdk src/core/plugin_distribution src/core/plugin_host src/plugin_host_runtime integrations/plugin_registry integrations/plugin_host templates/channel-plugin tests/test_plugin_sdk_phase17.py tests/test_plugin_distribution_phase18.py tests/test_plugin_host_phase19.py dashboard.py
